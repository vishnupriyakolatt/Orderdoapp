...
exports.hash = exports.verify = exports.sign = exports._hashSizes = void 0;
 ...
 */
function sign(data, secret, expires = -1, algorithm = "sha512") {
    if (typeof data === "string")
        data = Buffer.from(data, "utf8");
    const hashSize = exports._hashSizes[algorithm];
    ...
    // Hash
    const hashAlg = (0, crypto_1.createHmac)(algorithm, secret);
...
// }
//* HASH PASSWORDS
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function hash(data, secret, hashAlgorithm = "sha512") {</span></span>
<span class="cstat-no" title="statement not covered" >    if (typeof data === "string")</span>
<span class="cstat-no" title="statement not covered" >        data = Buffer.from(data, "utf8");</span>
<span class="cstat-no" title="statement not covered" >    const hashAlg = (0, crypto_1.createHmac)(hashAlgorithm, secret);</span>
<span class="cstat-no" title="statement not covered" >    hashAlg.update(data);</span>
<span class="cstat-no" title="statement not covered" >    return hashAlg.digest();</span>
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Thu Sep 30 2021 16:30:14 GMT+0100 (GMT+01:00)
            </div>
        </div>
